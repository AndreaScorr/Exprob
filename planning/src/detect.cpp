...
public:
  ...
  : plansys2::ActionExecutorClient("detect", 1s), progress_(0.0)
  {
    ...
    publisher_ = this->create_publisher<std_msgs::msg::String>("/updated_matrix_topic", 10);
...
protected:
        ...
        const rclcpp_lifecycle::State & previous_state) override
    {
        ...
        publisher_->on_activate();  // Attiva il publisher
        return rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn::SUCCESS;
    }
        ...
        const rclcpp_lifecycle::State & previous_state) override
    {
        ...
        publisher_->on_deactivate();  // Disattiva il publisher
        return rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn::SUCCESS;
    }
